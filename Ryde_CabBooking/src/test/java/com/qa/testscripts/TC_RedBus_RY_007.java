...
public class TC_RedBus_RY_007 extends TC_RedBus_RY_002 {
	@Test(dependsOnMethods = "main2", dataProvider="getData")
	public void main7(String destination) throws InterruptedException, IOException {
		...
		if (verifycabwin) {
			...
			captureScreenshot(driver, "main7");
