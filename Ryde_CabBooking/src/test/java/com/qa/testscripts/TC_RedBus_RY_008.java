...
public class TC_RedBus_RY_008 extends TC_RedBus_RY_002 {
	@Test(dependsOnMethods = "main2", dataProvider="getData")
	public void main8(String destination) throws InterruptedException, IOException {
		...
		if (verifycabwin) {
			...
			captureScreenshot(driver, "main8");
